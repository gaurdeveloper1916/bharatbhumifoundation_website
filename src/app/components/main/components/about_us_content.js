export default function AboutUsContent() {
  ...
  return (
    <div  style={{
      backgroundImage: 'url("https://www.helpageindia.org/wp-content/uploads/2024/09/background-overlay.svg")',
    }}>
<div
      className="mx-8 py-4 bg-cover bg-center"
     
    >
      <h1 className="font-semibold py-4 text-2xl text-black">
        Serving the elder cause for over four decades
      </h1>
